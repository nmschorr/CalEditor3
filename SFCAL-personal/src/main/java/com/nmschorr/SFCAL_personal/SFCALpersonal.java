/* SFCAL_personal.java by Nancy Schorr, 2015, 2022
 *
...
import com.nmschorr.SFCAL_personal.SectionpNew2;
...
public class SFCALpersonal extends SFCALpersonalutil {
	...
	public static void main(String[] args) {	
		...
		while (fileInDirCNT < arraysize) {  
			...
			SectionpNew2.sectionTask(tOUTone, tOUTtwo, finFILEnmWdir);
	...
	static String getindir() {  // 1 for name, 2 for file
		String iDIRNM = "E:\\sfcalfiles\\personal";
		return iDIRNM;
		}
	 
	// new method: ----------------------------------------------------------------	
	static String getoutdir() {  // 1 for name, 2 for file
		String oDIRNM =  "C:\\SFCALOUT\\personal";
		return oDIRNM;
		}
